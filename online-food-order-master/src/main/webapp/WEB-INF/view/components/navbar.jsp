...
<div class="container-fluid">
  ...
  <a class="navbar-brand"><h3 class="text-color"><i>Digital Dining Hub</i></h3></a>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <p style="font-size:23px;">
            <b>
                <img src="resources/images/phonee.png" style="width:27px;" alt="img">+1 207-450-2316 / +1 207-450-2317<br>
                <img src="resources/images/emaill.png" style="width:29px;" alt="img">digidinhub@gmail.com
            </b>
        </p>
        </div>
      </div>
