...
<title>Digital Dining Hub</title>
                     ...
                     <div class="card-columns hover">
                         ...
                         <div class="card">
                             ...
                             <div class="card-footer text-center">
                                 <p style="font-size:25px"><span class="ml-2"><b> &dollar;<%=Helper.getFoodSellingPrice(p.getPrice(), p.getDiscount()) %>/-</b></span>
                                 <span class="ml-2" style="font-size:20px;color:red"><s> &dollar;<%=p.getPrice()%></s></span>
